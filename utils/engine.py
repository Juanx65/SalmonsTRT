...
class EngineBuilder:
    ...
    def __build_engine(self,
        ...
        metadata = {
            "description": f'Engine generada para test.',
            "author": "Juan Aguilera",
            "date": '00:00:00',
            "version": 'v0.0.1',
            "license": "None",
            "docs": "https://github.com/Juanx65/ArtTRT/",
            "stride": 32,
            "task": 'segment',
            "batch": 16,
            "imgsz": input_shape[2:],
        ...
        if(input_shape[0] == -1): # solo si se hara un engine para batch size dinamico
            ...
            op_in_dims = trt.Dims4(8,input_shape[1],input_shape[2],input_shape[3])
            max_in_dims = trt.Dims4(16,input_shape[1],input_shape[2],input_shape[3])
        ...
        if ~fp32:
            ...
            if int8 and self.builder.platform_has_fast_int8:
                ## Carga de los datos
                calibration_file = get_calibration_files(calibration_data="datasets/salmons/images/val/")#"datasets/img_preprocess/")# "datasets/img_crop_test/" # para juanjo usar img_crop_test
